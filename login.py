...
####background image
image=Image.open('main1 copy.jpg')
...
def addUserToTable(username,emailId,password,age,gender):   
  connection = get_connection()
  cursor=connection.cursor()
...
def register():
  ...
  #     reg.destroy()
    ...
    # enter_btn.place(x=220, y=300)
      addUserToTable(fullname_value.get(),Email_value.get(),password_value.get(),Age_value.get(),Gender_value.get())   
